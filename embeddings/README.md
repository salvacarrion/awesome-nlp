...
### CNN char-embeddings + LSTM (7 Feb 2016; Arxiv)

[Exploring the Limits of Language Modeling](https://arxiv.org/abs/1602.02410), Rafal Jozefowicz, Oriol Vinyals, Mike Schuster, Noam Shazeer, Yonghui Wu
...
### ELMo (15 Feb 2018; NAACL)

[Deep contextualized word representations](https://arxiv.org/abs/1802.05365), Matthew E. Peters, Mark Neumann, Mohit Iyyer, Matt Gardner, Christopher Clark, Kenton Lee, Luke Zettlemoyer
...
### Positional embeddings (27 Dec 2019; ICLR)

[Encoding Word Order in Complex Embeddings](https://arxiv.org/abs/1912.12333), Benyou Wang, Donghao Zhao, Christina Lioma, Qiuchi Li, Peng Zhang, Jakob Grue Simonsen
...
### Word Embedding dimensionality (11 Dec 2018; NIPS)

[On the Dimensionality of Word Embedding](https://arxiv.org/abs/1812.04224), Zi Yin, Yuanyuan Shen
...
### mBERT / BERT (11 Oct 2018)

- **Summary:** Pretrained (BERT) model on the top 104 languages with the largest Wikipedia using a masked language modeling (MLM) objective.
...
### XML-R (5 Nov 2019; NIPS)

[Unsupervised Cross-lingual Representation Learning at Scale](https://arxiv.org/abs/1911.02116), Alexis Conneau, Kartikay Khandelwal, Naman Goyal, Vishrav Chaudhary, Guillaume Wenzek, Francisco Guzmán, Edouard Grave, Myle Ott, Luke Zettlemoyer, Veselin Stoyanov
